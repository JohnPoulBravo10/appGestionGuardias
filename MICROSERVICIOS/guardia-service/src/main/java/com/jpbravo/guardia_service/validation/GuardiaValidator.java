...
public class GuardiaValidator {
    ...
    /* Valida todas las reglas de negocio de una guardia.
       Incluye validación de coherencia de horario, duración
       (mínimo 4h, máximo 12h) y hora de inicio para guardias de hoy. */
